...
public class FirstConj {
	...
	public FirstConj(String first, String second, String third, String fourth, int index) {
		one = first;
		two = second;
		three = third;
		four = fourth;
	...
	public String getPresentActiveIndicative() {
		String [] endings = {"o", "as", "at", "amus", "atis", "ant"};
		String str = presentStem + endings[pos];
		return str;
	}
	
	public String getImperfectActiveIndicative() {
		String [] endings = {"abam", "abas", "abat", "abamus", "abatis", "abant"};
		String str = presentStem + endings[pos];
		return str;
	}
	
	public String getFutureActiveIndicative() {
		String [] endings = {"abo", "abis", "abit", "abimus", "abitis", "abunt"};
		String str = presentStem + endings[pos];
		return str;
	}
	...
	public String getPresentPassiveIndicative() {
		String [] endings = {"or", "aris", "atur", "amur", "amini", "antur"};
		String str = presentStem + endings[pos];
		return str;
	}
	
	public String getImperfectPassiveIndicative() {
		String [] endings = {"abar", "abaris", "abatur", "abamur", "abamini", "abantur"};
		String str = presentStem + endings[pos];
		return str;
	}
	
	public String getFuturePassiveIndicative() {
		String [] endings = {"abor", "aberis", "abitur", "abimur", "abimini", "abuntur"};
		String str = presentStem + endings[pos];
		return str;
	}
	...
	public String getPresentActiveSubjunctive() {
		String [] endings = {"em", "es", "et", "emus", "etis", "ent"};
		String str = presentStem + endings[pos];
		return str;
	}
	...
	public String getPresentPassiveSubjunctive() {
		String [] endings = {"er", "eris", "etur", "emur", " emini", "entur"};
		String str = presentStem + endings[pos];
		return str;
	}
