...
public class SecondConj {
	private String one, two, three, four, presentStem, perfectStem, subStem;
	private int pos;

	
	public SecondConj(String first, String second, String third, String fourth, int index) {
		one = first;
		two = second;
		three = third;
		four = fourth;
	...
	public String getPresentActiveIndicative() {
		String [] endings = {"eo", "es", "et", "emus", "etis", "ent"};
	...
	public String getFutureActiveIndicative() {
		String [] endings = {"ebo", "ebis", "ebit", "ebimus", "ebitis", "ebunt"};
		String str = presentStem + endings[pos];
		return str;
	}
	...
	public String getPresentPassiveIndicative() {
		String [] endings = {"eor", "eris", "etur", "emur", "emini", "entur"};
		String str = presentStem + endings[pos];
		return str;
	}
	...
	public String getFuturePassiveIndicative() {
		String [] endings = {"ebor", "eberis", "ebitur", "ebimur", "ebimini", "ebuntur"};
		String str = presentStem + endings[pos];
		return str;
	}
	...
	public String getPresentActiveSubjunctive() {
		String [] endings = {"eam", "eas", "eat", "eamus", "eatis", "eant"};
		String str = presentStem + endings[pos];
		return str;
	}
	...
	public String getPresentPassiveSubjunctive() {
		String [] endings = {"ear", "earis", "eatur", "eamur", "eamini", "eantur"};
		String str = presentStem + endings[pos];
		return str;
	}
